...
def train(run_manager, args, validate_func=None):
    ...
    for epoch in range(run_manager.start_epoch, run_manager.run_config.n_epochs + args.warmup_epochs):
        ...
        wdlog["train_loss"] = train_loss
        wdlog["train_top1"] = train_top1
        wdlog["train_top5"] = train_top5
        ...
        if (epoch + 1) % args.validation_frequency == 0:
            ...
            wdlog["val_loss"] = val_loss
            wdlog["val_top1"] = val_acc
            wdlog["val_top5"] = val_acc5
            ...
            if not distributed or run_manager.is_root:
                ...
                }, is_best=is_best, model_name = '%s_class' % run_manager.name)
